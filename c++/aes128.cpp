...
int main(const int argc, const char** argv) {
    std::string msg = "Hello World!", password = "password123";
    std::cout << "Message: " << msg << ", Password: " << password << "\n";
    std::string enc = aes::encrypt(msg, password);
    std::cout << "Encrypted message: " << enc << "\n";
    std::system("pause");
    std::string originalMsg = aes::decrypt(enc, password);
    std::cout << "Original message: " << originalMsg << "\n";
